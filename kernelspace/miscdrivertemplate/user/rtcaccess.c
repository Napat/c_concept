...
#define MISC_TEMP_NODE	"/dev/misc/"NODENAME
#define MODULE_FPATH	"/mnt/run/driver/miscdrv_template_drv.ko"
...
void rtcacc_init(void){
	...
	if( (devfd = open(MISC_TEMP_NODE, O_RDWR | O_SYNC | O_DSYNC | O_RSYNC) ) <= 0){
